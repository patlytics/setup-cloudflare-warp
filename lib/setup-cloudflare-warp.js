...
async function writeLinuxConfiguration(
  ...
  // disable man-db upgrade to skip "Processing triggers for man-db"
  // See https://askubuntu.com/questions/272248/processing-triggers-for-man-db/1476024#1476024
  await exec.exec("echo 'set man-db/auto-update false' | debconf-communicate; dpkg-reconfigure man-db");
}
